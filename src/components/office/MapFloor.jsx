...
const TILE_VIEW = {
  ...
  tv: { cls: 'tv', icon: '📺' },
  jukebox: { cls: 'jukebox', icon: '🎵' },
  bamboo: { cls: 'bamboo', icon: '🎋' },
  towel: { cls: 'towel', icon: '🧺' },
  dartboard: { cls: 'dartboard', icon: '🎯' },
  watercooler: { cls: 'watercooler', icon: '🚰' },
  mirror: { cls: 'mirror', icon: '' },
  beanbag: { cls: 'beanbag', icon: '🛋️' },
  disco: { cls: 'disco', icon: '🪩' },
